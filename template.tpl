...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "defaultValue": false,
    "help": "Wait for an \"init\" command before dispatching this event.\u003cbr/\u003e\u003cbr/\u003eAn \"init\" command can be generated by a tag with Tag Type \u003cstrong\u003einit\u003c/strong\u003e or by any other Tag Type that does \u003cstrong\u003enot\u003c/strong\u003e have the \u003cstrong\u003eDefer initialization\u003c/strong\u003e option checked (this automatic initialization by Amplitude tags can happen only once per page load).\u003cbr/\u003e\u003cbr/\u003eIf an \"init\" command has already been fired, the event will be dispatched immediately.",
    "enablingConditions": [
      {
        "paramName": "type",
        "paramValue": "init",
...
// Constants
const WRAPPER_VERSION = '3.0.0-beta.1';
